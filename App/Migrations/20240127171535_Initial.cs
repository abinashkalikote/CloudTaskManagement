        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecById = table.Column<long>(type: "bigint", nullable: false),
                    ProccedById = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CloudTaskId1 = table.Column<int>(type: "int", nullable: true),
                    CloudTaskId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CloudTasksLog_CloudTasksLog_CloudTaskId1",
                        column: x => x.CloudTaskId1,
                        principalTable: "CloudTasksLog",
                        principalColumn: "Id");
                    table.ForeignKey(
